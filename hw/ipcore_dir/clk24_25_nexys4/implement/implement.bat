...
xst -ifn xst.scr
move clk24_25_nexys4_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk24_25_nexys4_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk24_25_nexys4_exdes.ucf clk24_25_nexys4_exdes

echo 'Running map'
map -timing -pr b clk24_25_nexys4_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk24_25_nexys4_exdes -w routed.ncd routed.v
cd ..
